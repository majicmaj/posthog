                        ...
                        <div className="flex flex-wrap items-center justify-between gap-2">
                            <span>
                                {verificationAwaiting
                                    ? 'Verification email sent. Waiting for Gmail to forward it to PostHog.'
                                    : verificationTimedOut
                                      ? "We haven't received the verification email. Check that forwarding is enabled and saved in Gmail, then try again."
