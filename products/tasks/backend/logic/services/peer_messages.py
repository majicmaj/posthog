...
def validate_and_prepare_peer_message(
    ...
    content: str,
    artifact_ids: list[str],
) -> tuple[AgentPeerMessage, list[str], TaskRun] | PeerMessageRejection:
    ...
    return message, target_artifact_ids, target_run
...
def mark_peer_message_outcome(
    ...
    *,
    ...
    failure-isolation path can both report without racing each other."""
    updated = (
        AgentPeerMessage.objects.unscoped()
