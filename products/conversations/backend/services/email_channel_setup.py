...
def process_forwarding_challenges(
    *,
    ...
    return ForwardingChallengeResult.CONSUMED if saw_signed_challenge else ForwardingChallengeResult.NOT_CHALLENGE
